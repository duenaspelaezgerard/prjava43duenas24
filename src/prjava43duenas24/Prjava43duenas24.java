...
public class Prjava43duenas24 extends Frame 
   ...
   public Prjava43duenas24 () { 
      ...
      setTitle("nova finestra prjava43duenas24");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43duenas24();  // Let the construct do the job 
   } 
